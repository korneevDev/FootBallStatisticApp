...
class StatisticAdapter(
    ...
    override fun onBindViewHolder(holder: StatisticViewHolder, position: Int) {
        holder.bind(statisticList.getList()[position])
    }
...
sealed class StatisticViewHolder(view: View) : RecyclerView.ViewHolder(view) {

    abstract fun bind(uiModel: StatisticUIModel)

    class Defence(
        view: View
    ) : StatisticViewHolder(view) {

        override fun bind(uiModel: StatisticUIModel) {
